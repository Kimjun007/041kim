...
session_start();
require '../config.oho';
require 'auth_admid.php';
// ตรวจสอบสทิ ธิ์admin
if (!isset($_SESSION['ไอดผี ใู้ช'้]) || $_SESSION['สถำนะสทิ ธ'ิ] !== 'admin') {
...
<td><?= htmlspecialchars($user['emil']) ?></td>
...
onclick="return confirm('คณุ ตอ้ งกำรลบสมำชกินหี้ รอื ไม?' ่ )">ลบ</a>
</td>
</tr>
<?php endforeach; ?>
</tbody>
