...
<body class="container mt-4">
    ...
    <form method="post" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <input type="number" step="0.01" name="price" class="form-control" value="<?= TODO ?>" required>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-12">
            ...
            <textarea name="description" class="form-control" rows="4"><?= htmlspecialchars(TODO) ?></textarea>
        </div>
